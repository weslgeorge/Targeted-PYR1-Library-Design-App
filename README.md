...
<div style="overflow: hidden;">
  ...
  <img src="www/subset-mutationmatrix.png" alt="Mutation matrix example"
  ...
  <p>
    Identified similar small molecules used to inform the library will be selected in the <code>Amino Acid Input Generation</code>
    tab to generate a mutation matrix that informs the app what mutations at what positions in PYR1 to allow in the library.
  </p>
  ...
  <p>
    See the <code>Mutation matrix</code> sheet of the <code>Oligo summary data</code> download button for a template of the file —
    new rows can be added as long as the proper WT amino acid and position are added.
  </p>
